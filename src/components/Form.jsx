                ...
                <div className="form-body">
                    ...
                    <div className="form-line-4">   
                        <div className="form-line-4-label">
                            <label className="number"for="numero-carte">Numéro de carte :</label>
                            <label className="expiration"for="date-expiration">Date d'expiration :</label>
                            <label className="ccv"for="ccv">CCV :</label>
                        </div>
                        <div className="form-line-4-input">
                            <input type="text" id="numero-carte" name="numero-carte"  placeholder="**** **** **** ****"/>
                            <input type="text" id="date-expiration" name="date-expiration"  placeholder="00 / 00"/>
