...
export const dataBase = [
...

    {
        ...
        description: "Montbéliard est une commune de l'Est de la France, sous-préfecture du département du Doubs en région Bourgogne-Franche-Comté. Elle est située dans le nord-est de la Franche-Comté, à moins d'une vingtaine de kilomètres de la Suisse, aux portes du massif du Jura.",
        enfants: true,
        ambiance: detente,
...

    {
        ...
        enfants: true,
        ambiance: detente, soiree,
        environnement:  ville, campagne,sport,
        budget: abordable, 
    },
    {
        id : 14,
        ...
        description: "Annecy est une ville des Alpes située dans le sud-est de la France. C'est là que le lac d'Annecy se déverse dans le Thiou. Elle est réputée pour sa vieille ville avec ses rues pavées, ses canaux sinueux et ses maisons aux couleurs pastel. Surplombant la ville, le château médiéval d'Annecy, ancienne résidence des comtes de Genève, abrite un musée proposant des objets régionaux, tels que du mobilier alpin ou des œuvres religieuses, ainsi qu'une exposition sur l'histoire naturelle.",
        enfants: true,
        ambiance: detente, soiree,
        environnement: campagne, plage, sport,
        budget: cher, 
    },
    {
        id : 15,
